...
:::{.question}
Write hypotheses to address the question of whether weight gained during pregnancy has a linear association with infant birthweight. You may use the linear regression model output. Your hypotheses should be formulated mathematically, in terms of a parameter.
:::
